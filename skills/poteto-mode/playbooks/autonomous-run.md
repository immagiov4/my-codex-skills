...
2. Pick the available Codex wait or monitoring mechanism. Prefer an event-based watcher for CI, merges, or ref changes. Use a time-based check only when no event source exists.
