...
**You own a clean stop. Leave a checkpoint a cold-start agent can resume from.** Use this only when the user asks to pause or restart Codex. A request to keep going means continue. The Autonomous run playbook already checkpoints each iteration.
