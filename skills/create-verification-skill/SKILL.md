...
Use `$skill-creator` for the Codex skill structure, metadata, and validation rules. The feature-map requirements below define the verification-specific content.
