...
Use the runners available through Codex collaboration. Prefer inherited models. Use an override only when the user or an applicable instruction requests one and the model is available.
